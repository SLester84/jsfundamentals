...
var netflix = {
 ...
 //console.log('Season Info:' , netflix.season1.seasonInfo.episodeInfo[0].episodeName);
 console.log('Episode:' ,netflix.season1.seasonInfo.episodeInfo[6].episodeName[6]);
